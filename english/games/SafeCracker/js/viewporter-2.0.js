...
(function() {
    ...
    viewporter = {
        ...
        isLandscape: function() {
            ...
            return (window.xorientation||window.orientation) === 90 || (window.xorientation||window.orientation) === -90;
        },
    ...
    var _Viewporter = function() {
        ...
        var _onReady = function() {
            ...
            var cachedOrientation = (window.xorientation||window.orientation);
            window.addEventListener('orientationchange', function() {
                if((window.xorientation||window.orientation) !== cachedOrientation) {
                    that.prepareVisualViewport();
                    cachedOrientation = (window.xorientation||window.orientation);
                }
            }, false);
