...
(function () {
    ...
    a.remove = function (b) {
        ...
        if (a) {
            for (; a.length;) {
                ...
                for (c = this._loadQueueBackup.length - 1; c >= 0; c--) if (h = this._loadQueueBackup[c].getItem(), h.id == d || h.src == d) {
    ...
    a.installPlugin = function (b) {
        if (!(b == null || b.getPreloadHandlers == null)) {
            ...
            if (b.types != null) for (var a = 0, d = b.types.length; a < d; a++) this._typeCallbacks[b.types[a]] = b.callback;
    ...
    a._handleFileComplete = function (a) {
        ...
        if (this.maintainScriptOrder && d.type == createjs.LoadQueue.JAVASCRIPT) if (a instanceof createjs.TagLoader) this._currentlyLoadingScript = false;
        else {
...
(function () {
    ...
    if (typeof JSON.parse !== "function") JSON.parse = function (a, c) {
        ...
        if (/^[\],:{}\s]*$/.test(a.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, "@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, "]").replace(/(?:^|:|,)(?:\s*\[)+/g, ""))) return e = eval("(" + a + ")"), typeof c === "function" ? d({
            "": e
        }, "") : e;
