...
var ShareWords = locale[language]["holdup"];
...
//    },
...

    {
        ...
        var words= [locale[language]["name"],locale[language]["name2"],locale[language]["name3"],locale[language]["name4"]];
        ...
        if(this.time.toFixed(0)*1 > 50){
        	var a = this.time.toFixed(2);
        	var t = locale[language]["secret"];
            ShareWords =t.format(a);
        }else{
        	var b = this.time.toFixed(2);
        	var tt = locale[language]["comeon"];
            ShareWords =tt.format(b,text);
        }
