...
;~function(bt){
	...
	bt.URL = {
		...
		,getMoreGame: function(){
			...
			return "http://www.7k7k.com/2014/h5/list/";
		}
		,getConcern: function(){
			return "http://www.7k7k.com/2014/h5/list/";
		}
...
;~function(bt){
	...
	var loading = function(rate, error){
		if(rate > 0 && !loadingDiv){
			...
			loadingDiv.html('<table><tr><td><img class="bt-img" src="common/preloadImage.png" /><div class="bt-text"></div></td></tr></table>');
		...
		if(loadingDiv){
			if(error){
				...
				loadingText.html("Load progress:" + r + "%");
			}
		}
		if(rate >= 1){
...
;~function(bt){
	...
	function tip(){
		var a = bt.advertisement({
			id: id
			,html: "<img class='bt-play-share-tip-img' src='common/bt-play-share-tip.png' />"
			,time: 0
		});
		a.show();
...
;~function(bt){
	...
	var dataForWeixin={
	   ...
	   //src: "http://www.7k7k.com/2014/h5/list/",
	   url:location.href,
