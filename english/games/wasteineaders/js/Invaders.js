...
GAME.EnemyManager.prototype.update = function () {
    ...
    var a = (Math.sin(this.positionShift) + 1) / 2, b = this.spread / 2, c = 300 - b + this.startRange / 2 + this.waveLength;
...
GAME.EnemyBulletManager.prototype.fire = function (a, b) {
    ...
    var e = c.position.x - this.engine.player.position.x, d = c.position.y - this.engine.player.position.y, h = Math.sqrt(e * e + d * d);
    c.speedX = e / h * b;
    c.speedY = d / h * b
};
...
GAME.PickupManager.prototype.pickup = function (a) {
    if (!a.isPickedUp)switch (a.isPickedUp = !0, a.pickupPosition = {x: a.position.x, y: a.position.y}, a.ratio = 0, a.id) {
