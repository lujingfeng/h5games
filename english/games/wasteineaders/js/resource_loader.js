...
(function(){
    ...
    publicResourceLoader = new PublicResourceLoader({
        css:[],
        scripts:[
            'http://h5.static.myappgame.com/common/WeixinApi.js?ver='+Math.random(),
            'http://h5.static.myappgame.com/common/server.js?ver='+Math.random(),
            'http://h5.static.myappgame.com/common/common.js?ver='+Math.random(),
            'http://h5.static.myappgame.com/common/count.js?ver='+Math.random()
        ]
    });
}());
